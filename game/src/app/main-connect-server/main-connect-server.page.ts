...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonTitle, CommonModule, FormsModule, IonLabel, IonItem, IonButton, IonInput]
})
...
export class MainConnectServerPage implements OnInit {
  ...
  async JoinRoom() {
    ...
    this.toastService.createToast(`Conectando a ${this.serverIp}:${this.serverPort}`, 'warning');
